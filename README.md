...
| Table 1 panel A | Table1 panel A.do  |  新replica.dta | Compustat | 資料夾"table1_panelA"內 |
| Table 1 panel B | Table1 panel B and C.do |  新replica.dta | Compustat | 資料夾"Table 1_Panel B and C"內 |
...
| Table 7 Panel A | Table7 Panel A1.do | 完整主檔.dta；EPS真.dta；LBES_DISP.dta；DISP_FE.dta；新replica.dta | Compustat, LBES  | 資料夾"Table7_PanelA"內 |
